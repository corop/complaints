...
<link rel="stylesheet" type="text/css" media="screen"
      href='<spring:url value="resources/js/jquery-ui-1.9.1/themes/base/jquery-ui.css"/>'/>
<link rel="stylesheet" type="text/css" media="screen"
      href='<spring:url value="resources/js/jquery-file-upload/css/jquery.fileupload-ui.css"/>'/>
<link rel="stylesheet" type="text/css" media="screen"
      href='<spring:url value="resources/js/jquery-file-upload/css/jquery.fileupload-ui-noscript.css"/>'/>
...
<script type='text/javascript'
        src='<spring:url value="resources/js/jquery-file-upload/js/jquery.iframe-transport.js"/>'></script>
<script type='text/javascript'
        src='<spring:url value="resources/js/jquery-file-upload/js/jquery-fileupload.js"/>'></script>
...
<div class="portlet-block">
    <div class="portlet-round-border">
        <p class="portlet-title">
                <span>
                    Подача жалоб
                </span>
        </p>
        <form id="cmplform" class="block0 wizardForm">
        <div class="redPrompt"> Поля, отмеченные знаком  <img src="resources/img/attention.gif" width="16" height="16" alt="A!"/>, обязательны для заполнения. </div>
        <table width="640">
            <tr>
                <td>
                        <fieldset>
                            <legend>&nbsp;<strong>Жалоба, sid:&nbsp;<%=request.getSession().getId()%>
                            </strong>&nbsp;</legend>

                            <p><strong>Орган в который будет отправлена жалоба: </strong><img src="resources/img/attention.gif"
                                                                             width="16"
                                                                             height="16" alt="A!"/><br/>
                            ...
                            <p>Наименование органа, предоставляющего государственную услугу, должностного лица органа,
                                предоставляющего государственную услугу, либо федерального государственного служащего,
                                решения и
                                действия (бездействия) которых обжалуются <img src="resources/img/attention.gif"
                                                                               width="16"
                                                                               height="16" alt="A!"/><br>
                            ...
                            <table width="630" border="0">
                                <tr>
                                    ...
                                    <td width="218"><input name="who" type="radio" id="man" value="1"
                                                           checked="checked"/>
                            ...
                            <table width="697" border="0">
                                ...
                                <tr id="tr_firstname">
                                    <td width="135" align="right" valign="middle">Имя: <img
                                            src="resources/img/attention.gif"
                                ...
                                <tr id="tr_entitlement">
                                    <td width="135" align="right" valign="middle">Наименование: <img
                                            src="resources/img/attention.gif" width="16" height="16" alt="A!"/></td>
                                    <td align="left" valign="middle" nowrap="nowrap"><input name="entitlement"
                                                                                            type="text"
                                                                                            id="entitlement" size="80"
                                                                                            required="required"/></td>
                                </tr>
                                <tr>
                                    <td align="right" valign="middle">Местонахождение: <img
                                            src="resources/img/attention.gif"
                                            width="16" height="16" alt="A!"/>
                                    </td>
                                    <td align="left" valign="middle" nowrap="nowrap"><input name="post_index"
                                                                                            type="text"
                                                                                            id="post_index"
                                                                                            value="Индекс"
                                                                                            size="8"/>
                                ...
                                <tr>
                                    <td align="right" valign="middle">Адрес Email: <img
                                            src="resources/img/attention.gif"
                                            width="16" height="16" alt="A!"/></td>
                                    <td align="left" valign="middle" nowrap="nowrap"><input type="email" name="email"
                                                                                            id="email"
                                                                                            required="required"
                                                                                            size="80"/></td>
                                </tr>
                            ...
                            <select name="categories" size="1" id="categories"
                                    style="word-wrap:break-word;width:700px;">
                                <option id="-1" value="-1">Данные не загружены</option>
                            </select>

                            <p><strong>Текст обращения:</strong> <img src="resources/img/attention.gif" width="16"
                                                                      height="16"
                                                                      alt="A!"/><br/>
                            ...
                            <fieldset>
                                ...
                                <p>Если вы являетесь представителем физического или юридического лица, для отправки
                                    обращения
                                    вам необходимо приложить один из этих документов:</p>

                                <p> <img src="resources/img/next.gif" width="16"
                                         height="16"
                                         alt="A!"/>доверенность, оформленную в соответствии с законодательством Российской Федерации,
                                    заверенную печатью заявителя и подписанную руководителем заявителя или
                                    уполномоченным этим
                                    руководителем лицом;<br>
                                    <img src="resources/img/next.gif" width="16"
                                         height="16"
                                         alt="A!"/>копию решения о назначении или об избрании либо приказа о назначении физического
                                    лица на должность, в соответствии с которым такое физическое лицо обладает правом действовать от имени заявителя без
                                    доверенности.<br>
